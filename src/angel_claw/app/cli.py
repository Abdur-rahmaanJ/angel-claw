...
Usage ``angel_claw [OPTIONS] COMMAND [ARGS]...``

Example command 'welcome' has been added.
- To get your project version, run ``angel_claw --version``
- Run the sample command as ``angel_claw welcome [OPTIONS] NAME``
"""

from angel_claw import __version__
import click
...
def welcome(name, verbose):
    ...
    """
    click.secho(f"Hi {name}. Welcome to angel_claw", fg="cyan")
